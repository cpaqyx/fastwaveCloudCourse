...
/* 测试地址：
http://localhost:8082/auth/degradeApi?token=1234569
http://localhost:8082/auth/degradeApi?token=123456911111111111
 */
@RestController
@RequestMapping("/auth")
public class DegradeController {
     ...
     */
    //@SentinelResource(value = "degradeApi", fallback = "fallback4degradeApi", blockHandler = "blockHandler4degradeApi")
